            ...
            <div class="flex flex-wrap  py-10 justify-around ">
                ...
                <div class="w-full md:w-1/2 lg:w-2/5">
                    ...
                    <div class="w-full max-w-3xl mx-auto">
                        @if ($video)
                            <div
                                class="relative w-full pt-[56.25%] mt-8 bg-blue-50 border border-gray-300 shadow-lg rounded-lg overflow-hidden">
                        ...
                        @else
                            <div
                                class="w-full h-96 rounded-lg bg-blue-50 mt-8 border border-gray-300 flex flex-col items-center justify-center text-gray-600 shadow-lg">
                ...
                <div class="w-full md:w-1/2 lg:w-2/5  flex justify-center">
                    <div class="font-bold">
                        ...
                        <div class="flex gap-4 text-white mb-12">
                            <div id="antrian-umum"
                                class="bg-green-400 w-full md:w-48 h-24 rounded-lg flex items-center justify-center shadow-lg text-3xl">
                                </div>
                        </div>
