    ...
    <div class="flex">
        ...
        <main class="w-full flex flex-col ">
            ...
            <main class="container mx-auto py-10 ">
                ...
                <div class="flex items-center mt-20 container justify-center gap-8 p-4 ">
    
                    <div class="flex items-center gap-4">
                        <label for="tanggal" class="text-black font-semibold mb-1 flex rounded-lg">Cari Tanggal:</label>
                        <input type="text" id="tanggal" class="text-black px-8 py-2 rounded border border-gray-300 focus:outline-none focus:border-indigo-500">
                    </div>
                
                    <div class="flex  items-center gap-4">
                        <label for="bulan" class="text-black font-semibold mb-1">Pilih Bulan:</label>
                        <select id="bulan" class="rounded-lg border border-gray-300 shadow-sm focus:border-indigo-500 
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <input type="text" id="tahun" class="text-black px-8 py-2 rounded border border-gray-300 focus:outline-none focus:border-indigo-500">
                    </div>
                
                    <button class="bg-green-500 px-8 py-2 font-semibold rounded-lg text-white flex justify-center items-center gap-3 text-xl transform transition hover:scale-110 duration-300">
                        <span>Cari</span>
