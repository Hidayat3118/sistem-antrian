            ...
            <div id="print-preview"
                ...
                <div class="bg-slate-200 p-10 rounded-lg w-11/12 max-w-2xl ">
                    ...
                    <div class="container mx-auto flex justify-center ">
                        <div
                            class="bg-white rounded-xl shadow-xl p-10 max-w-lg w-full  transition-transform duration-300 hover:shadow-2xl  py-20">
                            <div class="text-center">
                                <h2 class="text-4xl font-extrabold text-blue-800">No Antrian Anda</h2>
                                <h1
                                    class="text-6xl font-semibold text-green-500 mt-4 border-b-4 border-green-400 inline-block pb-2">
                    ...
                    <div class="flex mt-10 justify-center">
                        <button onclick="submit"
                            class="text-2xl font-semibold text-white bg-red-500 hover:bg-red-600 py-3 px-8 rounded-lg shadow-lg flex items-center transition ">
                            <i class="fas fa-print mr-3"></i> CETAK
                        </button>
                    </div>
                </div>
