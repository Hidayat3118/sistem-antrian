...
@section('content')
    ...
    <main class="bg-gradient-to-b from-blue-50 to-blue-100 min-h-screen py-10">
        ...
        <div class="container mx-auto flex justify-center mt-16">
            <div class="bg-white rounded-xl shadow-xl p-10 max-w-lg w-full">
                {{-- Header Antrian --}}
                <h3 class="text-3xl font-bold text-green-500 mb-4 text-center ">Antrian Umum</h3>
                
                {{-- Informasi Antrian --}}
                <div class="text-center">
                    <h2 class="text-4xl font-extrabold text-blue-800">No Antrian Anda</h2>
                    <h1 class="text-6xl font-semibold text-green-600 mt-4 border-b-4 border-green-400 inline-block pb-2">A009</h1>
                ...
                <div class="flex mt-10 justify-center">
                    <button
                        class="text-2xl font-semibold text-white bg-green-600 hover:bg-green-700 py-3 px-8 rounded-lg shadow-lg flex items-center transition duration-300 transform hover:scale-105">
